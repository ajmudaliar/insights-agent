...
export function ConversationCard({ conversationId, configId, assignment, isSubcategory }: ConversationCardProps) {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [isOpen, conversationId, configId]);
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={setIsOpen}>
      <div className="border border-border/40 rounded-md bg-white hover:bg-accent/5 transition-colors duration-150">
        {/* Header */}
        ...
        {/* Expanded Content */}
        <CollapsibleContent>
          <div className="px-4 pb-4 space-y-6 border-t border-border/30">
            {isLoading ? (
