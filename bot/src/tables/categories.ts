...
export const CategoriesTable = new Table({
  ...
  columns: {
    ...
    description: z.string().describe("Detailed description (optional, filled during refinement stage)").optional(),
    category_type: z.string().describe("Type: usage_pattern, error_mode, user_behavior, feature_request, other").optional(),
    key_characteristics: z.array(z.string()).describe("3-5 key characteristics defining this category").optional(),
